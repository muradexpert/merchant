...
import com.bestcommerce.authserver.dto.UserDto;
...
public class JwtTokenProvider implements InitializingBean {
    ...
    public String createToken(Authentication authentication, boolean rememberMe) {
        com.bestcommerce.authserver.entity.User user =userRepository.findOneWithAuthoritiesByUsername(authentication.getName()).get();
    ...
    public Authentication getAuthentication(String token) {
        ...
        Collection<? extends GrantedAuthority> authorities =claims.get(AUTHORITIES_KEY).toString().isEmpty()? Collections.emptyList():
